...
├── test_results/               - Results downloaded from F-Testers for application testing
├── unit_tests/                 - Unit tests (e.g., for connectionSpeed.py)
├── build_metelTest.py          - Environment build and test customization script
...
├── install.sh                  - Installation script for dependencies and environment setup
...
├── processKill.py              - Tool for terminating running tcpdump and macof processes
